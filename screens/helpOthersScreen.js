...
import { FlatList } from 'react-native-gesture-handler';
    ...
    export default class RequestScreen extends React.Component{
      ...
      //      var books =  BookSearch.searchbook("game",'AIzaSyCfnrjmj_jzJ4RPRNBmT4Z0oFATaVf13ng')
        //  console.log(books)
          }
          getBooksFromApi= async(bookName) =>{
            ...
            this.setState({bookName:bookName
              ...
              //  var books = await BookSearch.searchbook(bookName,'AIzaSyCfnrjmj_jzJ4RPRNBmT4Z0oFATaVf13ng')
                this.setState({
       ...
       <Text> {item.volumeInfo.title} </Text>
        ...
        render(){
            if(this.state.IsBookRequestActive===true){
                return(
                    <View style={{flex:1,justifyContent:'center'}}>
                        ...
                        <View style={{borderColor:"orange",borderWidth:2,justifyContent:'center',alignItems:'center',padding:10,margin:10}}>
                            <Text>Book Statue</Text><Text>{this.state.bookStatus}</Text>                           
                        </View>
                        <TouchableOpacity 
            ...
            return(
              ...
              />
              {this.state.showFlatList?(<FlatList data={this.state.dataSource} renderItem={this.renderItem} style={{marginTop:10}} keyExtractor={(item,index)=>{index.toString()}} enableEmptySections={true}/>):(
